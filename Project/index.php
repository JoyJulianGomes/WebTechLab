...
<html>
    <head>
        ...
        <link rel="stylesheet" href="eb0000_theme.css">
        <style>
            h1,h2,h3,h4,h5,h6{
                padding:0px;
                margin:0px;
        ...
        <div id="id01" class="w3-theme-l2">
            ...
            <form class="login-form">
                <table>
                    ...
                    <tr><td colspan=2>
                        <button style="width:100%" onclick="CredCheck(document.getElementById('uname').val(), document.getElementById('pass').val())">
